...
public class Projeto extends Slogan {
		...
		if (desejaComprar == 'S') {
			...
			do {// INICIO LAÇO COMPRA
				...
				if (produtoIgual.equals(auxCod)) {
					...
					System.out.println("Codigo informado não existe!"); // incentiva a continuar a compra (linha 147)
				}
